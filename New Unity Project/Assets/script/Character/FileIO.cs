...
public static class FileIO
{
    ...
    public static void SaveByBin(string path, object pObject)
    {
        //序列化过程（将save对象转换为字节流）
        //创建save对象并保存当前游戏状态
        //创建一个二进制格式化程序
        ...
        bf.Serialize(fileStream, pObject);
        //关闭流
        fileStream.Close();

    }
    public static object LoadByBin(string path)
    {
        //反序列化过程
        //创建一个二进制格式化程序
        BinaryFormatter bf = new BinaryFormatter();
        ...
        SaveData data = bf.Deserialize(fileStream) as SaveData;
        //关闭文件流
        fileStream.Close();
        return data;
    }
